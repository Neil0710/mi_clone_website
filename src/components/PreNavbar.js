...
const PreNavbar = () => {
  return (
    <div className="preNav">
      <div>
        <a href="https://www.mi.com/in/" id="firstELement">
          XIAOMI INDIA
        </a>{" "}
        <span>|</span>
        ...
        <a
          ...
          className="preNavDropdown"
        >
          RETAIL STORE <span className="arrow down"></span>
        </a>
      </div>
      <div>
        ...
        <span>|</span>
        <a
          href="https://store.mi.com/in/site/login"
          className="cartIcon preNavDropdown"
        >
          {cartIcon} <span> CART (0)</span>
        </a>
      </div>
    </div>
  );
